...
export const GetMeResponse = zod.object({
  ...
  points: zod.number(),
  rank: zod.string(),
  prestigeStars: zod.number(),
  totalEarnings: zod.number(),
  pointShifts: zod.string().nullish(),
});
...
export const GetTournamentsResponseItem = zod.object({
  ...
  maps: zod.string().nullish(),
  killPoints: zod.number().optional(),
  placements: zod.string().nullish(),
  prizeDistribution: zod.string().nullish(),
  teamSize: zod.string(),
...
export const CreateTournamentBody = zod.object({
  ...
  mapName: zod.string().nullish(),
  matchCount: zod.number().optional(),
  maps: zod.array(zod.string()).nullish(),
  killPoints: zod.number().optional(),
  placements: zod.array(zod.number()).nullish(),
  prizeDistribution: zod
    .array(
      zod.object({
        rank: zod.number(),
        label: zod.string(),
...
export const GetResultsQueryParams = zod.object({
  tournamentId: zod.coerce.number().optional(),
  registrationId: zod.coerce.number().optional(),
  mine: zod.coerce
    .boolean()
    .optional()
    .describe("Filter to only the current user's registrations"),
});
