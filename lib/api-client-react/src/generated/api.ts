...
export const requestStorageUploadUrl = async (
  requestStorageUploadUrlBody: RequestStorageUploadUrlBody,
  options?: RequestInit,
): Promise<RequestStorageUploadUrl200> => {
  return customFetch<RequestStorageUploadUrl200>(
    getRequestStorageUploadUrlUrl(),
    {
      ...options,
      method: "POST",
      headers: { "Content-Type": "application/json", ...options?.headers },
      body: JSON.stringify(requestStorageUploadUrlBody),
    },
  );
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<RequestStorageUploadUrlBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type RequestStorageUploadUrlMutationResult = NonNullable<
  Awaited<ReturnType<typeof requestStorageUploadUrl>>
>;
export type RequestStorageUploadUrlMutationBody =
  BodyType<RequestStorageUploadUrlBody>;
